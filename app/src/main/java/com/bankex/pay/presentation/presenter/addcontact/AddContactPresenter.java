...
public class AddContactPresenter extends BasePresenter<IAddContactView> {
	...
	public void onSaveContactClicked(String name, String surname, String address) {
		if (name == null || name.isEmpty()) {
			getViewState().showError(R.id.til_first_name, R.string.add_contact_error_first_name);
		} else if (surname == null || surname.isEmpty()) {
			getViewState().showError(R.id.til_surname, R.string.add_contact_error_surname);
		} else if (address == null || address.isEmpty()) {
			getViewState().showError(R.id.til_address, R.string.add_contact_error_address);
		} else {
			// TODO save in db
		}
	}
